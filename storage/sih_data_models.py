...
class AIH:
    def __init__(self, metadata):
        ...
        self._dummy_ = ['UF_ZI','ANO_CMPT','MES_CMPT','ESPEC','CGC_HOSP','N_AIH',
                        'IDENT','CEP','MUNIC_RES','NASC','SEXO','UTI_MES_IN','UTI_MES_AN',
                        'UTI_MES_AL','UTI_MES_TO','MARCA_UTI','UTI_INT_IN','UTI_INT_AN',
                        'UTI_INT_AL','UTI_INT_TO','DIAR_ACOM','QT_DIARIAS','PROC_SOLIC',
                        'PROC_REA','VAL_SH','VAL_SP','VAL_SADT','VAL_RN','VAL_ACOMP','VAL_ORTP',
                        'VAL_SANGUE','VAL_SADTSR','VAL_TRANSP','VAL_OBSANG','VAL_PED1AC',
                        'VAL_TOT','VAL_UTI','US_TOT', 'DT_SAIDA','DIAG_PRINC',
                        ...
                        'INSC_PN','SEQ_AIH5','CBOR','CNAER','VINCPREV','GESTOR_COD','GESTOR_TP',
                        'GESTOR_CPF','GESTOR_DT','CNES','CNPJ_MANT','INFEHOSP','CID_ASSO',
                        'CID_MORTE','COMPLEX','FINANC','FAEC_TP','REGCT','RACA_COR','ETNIA',
                        #'REMESSA',
                        "FONTE"]
        ...
        self.model = Table(
            ...
            Column('NASC', String(8), nullable=True),
            ...
            Column('DT_SAIDA', String(8), nullable=True),
...
class ServicosAIH:
    def __init__(self, metadata):
        ...
        self._dummy_ = ['SP_GESTOR',#'SP_UF',
                        ...
                        'SP_VALATO','SP_M_HOSP','SP_M_PAC','SP_DES_HOS','SP_DES_PAC',
                        'SP_COMPLEX','SP_FINANC','SP_CO_FAEC','SP_PF_CBO',
                        #'SP_PF_DOC','SP_PJ_DOC',
                        'IN_TP_VAL',
                        #'SEQUENCIA','REMESSA',
