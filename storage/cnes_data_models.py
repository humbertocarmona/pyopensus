...
class Leitos:
    def __init__(self, metadata):
        self.metadata = metadata
        self.table_name = 'cnes_leitos'
        self._dummy_ = [
            'CNES', 'CODUFMUN', 'REGSAUDE', 'MICR_REG', 'DISTRSAN', 'DISTRADM',
        ...
        self.model = Table(
            ...
            Column('QT_EXIST', Numeric(4), nullable=True),
            Column('QT_CONTR', Numeric(4), nullable=True),
            Column('QT_SUS', Numeric(4), nullable=True),
            Column('COMPETEN', String(6), nullable=True),
            Column('FONTE', String, nullable=True)
        )
...
class Profissionais:
    def __init__(self, metadata):
        self.metadata = metadata
        self.table_name = 'cnes_profissionais'
        self._dummy_ = [
            'CNES', 'CODUFMUN', 'REGSAUDE', 'MICR_REG', 'DISTRSAN', 'DISTRADM',
            'TPGESTAO', 'PF_PJ', 'CPF_CNPJ', 'NIV_DEP', 'CNPJ_MAN', 'ESFERA_A',
            'ATIVIDAD', 'RETENCAO', 'NATUREZA', 'CLIENTEL', 'TP_UNID', 'TURNO_AT',
            'NIV_HIER', 'TERCEIRO', 'CPF_PROF', 'CPF_UNICO', 'CBO', 'CBO_UNICO',
            'NOMEPROF', 'CNS_PROF', 'CONSELHO', 'REGISTRO', 'VINCULAC', 'VINCUL_C',
            'VINCUL_A', 'VINCUL_N', 'PROF_SUS', 'PROFNSUS', 'HORAOUTR', 'HORAHOSP',
            'HORA_AMB', 'COMPETEN', 'UFMUNRES', 'NAT_JUR', "FONTE"
        ]
        ...
        self.model = Table(
            ...
            Column('NIV_HIER', String(2), nullable=True),
            Column('TERCEIRO', String(1), nullable=True),
            Column('CPF_PROF', String(11), nullable=True),
            Column('CPF_UNICO', String(6), nullable=True),
            Column('CBO', String(6), nullable=True),
            Column('CBO_UNICO', String(2), nullable=True),
            Column('NOMEPROF', String(60), nullable=True),
            ...
            Column('HORAOUTR', String(3), nullable=True),
            Column('HORAHOSP', String(3), nullable=True),
            Column('HORA_AMB', String(3), nullable=True),
            Column('COMPETEN', String(6), nullable=True),
            Column('UFMUNRES', String(8), nullable=True),
            Column('NAT_JUR', String(4), nullable=True),
            Column('FONTE', String, nullable=True)
        )
